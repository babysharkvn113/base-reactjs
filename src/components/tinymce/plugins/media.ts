...
export type THandlePopupSelectImageTinyMcePlugin = () => void;

const MediaTinyMcePlugin = (editor: Editor, handlePopup: THandlePopupSelectImageTinyMcePlugin): void => {
  editor.ui.registry.addIcon('mediaIcon', `<svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
<g>
  ...
  // Add the button with the custom icon
  editor.ui.registry.addButton('myimagebutton', {
    icon: 'mediaIcon', // Use the registered custom icon
    tooltip: 'Chọn ảnh', // Optional: Add a tooltip for better UX
    onAction: () => {
      handlePopup(); // Call the popup handler
    },
  });
};

export default MediaTinyMcePlugin;
